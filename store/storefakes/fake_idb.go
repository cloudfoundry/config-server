...
func (fake *FakeIDb) ExecReturnsOnCall(i int, result1 sql.Result, result2 error) {
	fake.ExecStub = nil
...
func (fake *FakeIDb) QueryReturnsOnCall(i int, result1 store.IRows, result2 error) {
	fake.QueryStub = nil
...
func (fake *FakeIDb) QueryRowReturnsOnCall(i int, result1 store.IRow) {
	fake.QueryRowStub = nil
